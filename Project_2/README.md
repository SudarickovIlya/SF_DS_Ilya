...
## 1. Описание проекта    
Необходимо произвести обработку и анализ базы данных вакансий, выгруженной с сайта *hh.ru*.
...
Каждая часть состоит из блока практических заданий и контрольных вопросов на платформе, отвечая на которые можно проверить верность решения. На основании комментариев ментора все запросы в sql сделаны таким образом, чтобы сразу давать ответы на контрольные вопросы. Комментарии в ячейках дают понять, когда код предназначен для решения задания, а когда - для ответа на контрольные вопросы.
